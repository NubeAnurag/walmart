...
import { Shield, Eye, EyeOff, Loader2, Mail, Lock, ArrowLeft } from 'lucide-react';
      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Access the employee management system</p>
          </div>

          {/* Security Notice */}
          <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 mb-6">
            <h3 className="font-semibold text-amber-900 mb-2">🔒 Secure Admin Access</h3>
            <p className="text-sm text-amber-800">
              This is a secure admin portal. Only authorized administrators can access the employee management system.
            </p>
          </div>
